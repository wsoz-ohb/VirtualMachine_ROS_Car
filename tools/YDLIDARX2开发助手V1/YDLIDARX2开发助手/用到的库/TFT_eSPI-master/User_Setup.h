...
//#define TFT_MISO 19 //21  // Master In, Slave Out 引脚用于传输从设备的数据到主设备
#define TFT_MOSI 23   //23  // Master Out, Slave In 引脚用于发送数据到从设备
#define TFT_SCLK 18   //22  // Serial Clock  串行时钟线，用于同步数据传输。
#define TFT_CS    5   //5   // Chip select control pin  或 Slave Select即SS 从机选择线，也称为CS（Chip Select）线。当SS线被拉高时，从设备则进入待机状态。
#define TFT_DC    2   //26  // Data Command control pin
#define TFT_RST   4   //25  // Reset pin (could connect to RST pin)
